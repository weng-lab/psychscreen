...
import { EmptyTrack, GraphQLTranscriptTrack, PackTranscriptTrack, SquishTranscriptTrack } from 'umms-gb';
...
const GeneTrack: React.FC<GeneTrackProps>
    = ({ assembly, position, onHeightChanged, transform }) => {
        ...
        return (
            <g transform={transform}>
                <GraphQLTranscriptTrack
                    ...
                    domain={position}
                    transform=""
                    onHeightChanged={height => { onHeightChanged && onHeightChanged(height); setHeight(height) }}
                >
                    <EmptyTrack
                        height={40}
