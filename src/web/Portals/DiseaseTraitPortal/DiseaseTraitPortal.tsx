            ...
            <Grid container {...props}> 
                ...
                <Grid item sm={8} md={6} lg={5} xl={4}>
                    ...
                    <Container  style={{ width:"741px", marginTop: "147px" }} fixed>
                        ...
                        >
                            Explore heritability enrichment for {DISEASE_CARDS.length} distinct psychiatric, behavioral, and neuronal traits within gene regulatory
                            features, such as bCREs and quantitative trait loci (QTLs). Search genes associated with complex traits based on PsychENCODE TWAS.
                        </Typography>
                        <Typography
                            type="body"
                            size="large"
                        ...
                        >
                            <CheckIcon style={{ marginRight: "9px" }} /> {DISEASE_CARDS.length} total traits cataloged
                        </Typography>
                        <Typography
                            type="body"
                            size="large"
