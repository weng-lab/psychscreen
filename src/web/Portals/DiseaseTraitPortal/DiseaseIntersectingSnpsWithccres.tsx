        ...
        <br/>
          ...
          {intersectingSnps.filter(i=>i.bcre_class!==".")  &&
            ...
            tabIndex === 1 && (
              <>
                <br />
                {intersectingSnps.filter(i=>i.bcre_class==="adult-only") && (
                  <StyledButton
                ...
                &nbsp;&nbsp;&nbsp;
                {intersectingSnps.filter(i=>i.bcre_class==="fetal-only") && (
                  <StyledButton
                  ...
                  >
                   ...
                   &nbsp;&nbsp;&nbsp;
                {intersectingSnps.filter(i=>i.bcre_class==="shared-fetal-adult") && (
                  <StyledButton
