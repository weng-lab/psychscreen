...
const sevenGroupTrack = (pos: GenomicRange, x: BiosampleEntry) => {
    ...
    return { chr1: pos.chromosome!, start: pos.start, end: pos.end, url: `http://gcp.wenglab.org/hubs/integrative1/data/seven-group/${r.join("_")}.7group.bigBed`, preRenderedWidth: 1400 };
}
...
const BiosampleTracks: React.FC<BiosampleTrackProps> = props => {
    ...
    const { data, loading } = useQuery<QueryResponse>(QUERY, { variables: { bigRequests: ttracks }});
