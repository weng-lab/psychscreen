...
const FooterPanel: React.FC<GridProps> = props => { 
    ...
    <Grid container {...props}>
        <Grid style={{ backgroundColor: "#000000", color: "#ffffff" }} item sm={3}>
            ...
            <Container style={{ marginTop: "116px" }}>
                ...
                <div style={{ marginLeft: "10px" }}>
                    <Typography
                        ...
                        style={{ color:"#1976d2", textDecoration: 'underline', fontSize: "14px", lineHeight: "20px", fontWeight: 400, letterSpacing: "0.1px", marginBottom: "10px" }}
                    >
                        Overview
                    </Typography>
                    <Typography
                    ...
                    >
                        ...
                        <Link href="https://psychencode.synapse.org/">PsychENCODE Consortium</Link>
        ...
        <Grid style={{ backgroundColor: "#000000", color: "#ffffff" }} item sm={1}>
            <Container style={{ marginTop: "116px" }}>
                <Typography
                    ...
                    style={{ color:"#1976d2", textDecoration: 'underline', fontSize: "16px", lineHeight: "24px", fontWeight: 700, letterSpacing: "0.5px", marginBottom: "21.5px" }}
                >
                    Downloads
                </Typography>
            </Container>
